...
// CORREÇÃO PRINCIPAL: Força filtro por categoria masculino
            ...
            <main class="lg:w-3/4">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                    <div class="mb-4 sm:mb-0">
                        ...
                        <p class="text-gray-600 text-sm">Camisetas masculinas de anime premium</p>
                    </div>
                </div>
        ...
        <div class="p-6">
            ...
            <div class="flex items-center justify-between mb-6 border-b border-gray-200 pb-4">
                ...
                <div class="flex items-center space-x-4">
                    <a href="masculino.php" class="text-red-500 text-sm hover:text-red-600 font-medium">
                        Limpar Tudo
                    </a>
            ...
            <form method="GET" action="masculino.php" id="mobile-filter-form">
                <!-- Anime Filter -->
                <div class="mb-6">
